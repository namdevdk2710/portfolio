...
export default function Project({
  ...
  return (
    ...
    >
      <section className="group bg-gray-100 max-w-[42rem] borderBlack overflow-hidden sm:pr-8 relative sm:h-[20rem] even:pl-8 hover:bg-gray-200 transition rounded-lg dark:bg-white/10 dark:hover:bg-white/20">
